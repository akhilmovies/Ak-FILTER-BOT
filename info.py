...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002393589774')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002436581560')).split()]  # For Multiple Id Use One Space Between Each.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/AKHDMOVIESSS') # Support Chat Link Without https:// or @
